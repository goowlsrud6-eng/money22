...
# --- [Tab 1] 발주서 등록 및 관리 (참조 표시 제거 및 기능 보강) ---
with tabs[1]:
    ...
    with c1:
        ...
        st.divider()
        # 수기 등록 폼 (발주차수 필드 포함)
        with st.form("manual_ord_form_v136", clear_on_submit=True):
            st.write("**수기 발주 입력**")
    ...
    with c2:
        ...
        if not o_data.empty:
            ...
            # 마감 건 회색 스타일 처리 [cite: 57]
            def style_orders_v136(df):
